...
function drawBasic() {
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        title: '7 Besar Desa Terbanyak Kab. Halmahera Selatan',
        is3D: true,
        width:'100%',
        height: 300,
        colors: [vihoAdminConfig.primary, vihoAdminConfig.secondary, "#f1c40f", "#27ae60", "#717171","#c0392b","#e67e22"]
      };
  ...
  if ($("#combo-chart").length > 0) {
      var data = google.visualization.arrayToDataTable([
        ['Month', 'Sakit', 'Hadir', 'Alpa', 'Izin TL', 'Tanpa Keterangan', 'Average'],
        ['2022/07',  165,      938,         522,             998,           450,      614.6],
        ['2022/08',  135,      1120,        599,             1268,          288,      682],
        ['2022/09',  157,      1167,        587,             807,           397,      623],
        ['2022/10',  139,      1110,        615,             968,           215,      609.4],
        ['2022/11',  136,      691,         629,             1026,          366,      569.6]
      ]);
      var options = {
        title : 'Trafik Kinerja ASN & Non ASN 1 Tahun Terkahir Di Kab. Halmahera Selatan',
        vAxis: {title: 'Cups'},
        hAxis: {title: 'Month'},
        seriesType: 'bars',
        series: {5: {type: 'line'}},
        height: 500,
        width:'100%',
        colors: [vihoAdminConfig.secondary, vihoAdminConfig.primary, "#c0392b", "#717171", "#e2c636"]
    };
  ...
  if ($("#area-chart-dashboard-default").length > 0) {
    ...
    if ($("#bar-chart2").length > 0) {
        var a = google.visualization.arrayToDataTable([
                ...
                ["TOBELO-GALELA", 50260, vihoAdminConfig.primary],
                ["MAKIAN-KAYOA", 40167, vihoAdminConfig.secondary],
                ["BUTONG", 25980, "#2980b9"],
                ["BACAN", 24089, "color: #c0392b"],
                ["BAJO", 21890, "color: #e67e22"]
            ]),
        ...
        var b = {
                title: "5 Besar Suku Di Kab. Halmahera Selatan",
                width:'100%',
                height: 500,
                bar: {
                    groupWidth: "95%"
